 ...
 * @LastEditTime: 2020-09-05 17:57:40
 * @Description:
 */
...
Page({
  ...
  numberset(e) {
    if (!e.detail.value) {
      ...
      this.setData({
        setNumber: e.detail.value >= 1 ? e.detail.value : 1,
      });
      this.setoderconfirm();
    }
  },
  ...
  cut() {
    let add = this.data.setNumber === "" ? 1 : this.data.setNumber;
    this.setData({
      setNumber: add !== 1 ? add - 1 : 1,
    });
    this.setoderconfirm();
  },
  add() {
